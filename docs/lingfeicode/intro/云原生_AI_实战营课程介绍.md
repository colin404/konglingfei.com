...
> 提示：
> - Go 语言基础课、Go 项目开发进阶实战课「Go 进阶训练营」和「云原生 AI 实战营」均有。其他课程只有「云原生 AI 实战营」有；
...
- 课程目录：[Go项目开发极速入门课](https://www.yuque.com/konglingfei-vzag4/cloud/gwgk5rhl5coycax0#Pob3)
...
星球中的高级实战课程是我的极客时间专栏「[Go 语言项目开发实战](https://time.geekbang.org/column/intro/100079601)」的升级版：
● 优化了软件架构；
● 适配了最新的 Go 版本；
● 优化、修正、增加了很多内容；

本课程的目的是让开发者进阶为高级开发工程师，适合学习完中级实战课之后的学习进阶。本套课程包含了 Go 项目开发中绝大部分开发技术点，包含但不限于以下技术点：

<img src="/images/高级实战课技术思维导图.png" alt="fenxiang" style="display: block;width:800px;height:auto;margin-left: 0;margin-right:auto;">

- 课程目录：[Go项目开发高级实战课](https://www.yuque.com/konglingfei-vzag4/cloud/gwgk5rhl5coycax0#tCdy)
- 课程实战项目：[iam](https://github.com/marmotedu/iam)
...
+ 课程目录：[LLMOPS 开发实战课](https://www.yuque.com/konglingfei-vzag4/cloud/gwgk5rhl5coycax0?singleDoc#mR1F)；
